...
$no_need_login_page=array("/block.php","/panel/login.php","/panel/forget_password.php","/panel/logout.php","/api/user/","/api/statistics/","/api/item/","/pay/","/api/city.php","/api/gift_type.php","/api/actor.php");
