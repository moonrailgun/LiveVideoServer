    ...
    <div id="myTabContent" class="tab-content">
        <div class="tab-pane active in" id="home">
          <form id="tab" method="post" action="" autocomplete="off">
            ...
            <label>设备编号</label>
            <input type="text" name="machine_id" value="<{$rule_info.machine_id}>" class="input-xlarge" required="true" >
            <label>设备状态</label>
            <select name="machine_status" class="input-xlarge">
              <{html_options options=$status_list selected=$rule_info.machine_status}>
            </select>
            <label>道具</label>
