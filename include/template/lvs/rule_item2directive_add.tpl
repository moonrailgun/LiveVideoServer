	...
	<div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
        <form id="tab" method="post" action="" autocomplete="off">
          ...
          <label>指令地址</label>
          <input type="text" name="address" value="<{$_POST.address}>" class="input-xlarge" required="true" >
          <label>命令</label>
          <input type="text" name="directive" value="<{$_POST.directive}>" class="input-xlarge" required="true" >
          <label>参数</label>
          <input type="text" name="param" value="<{$_POST.param}>" class="input-xlarge" required="true" >
